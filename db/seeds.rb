...
@user2 = User.create!(username: 'John', email: 'john@email.com', password: '654321' )
 ...
 @wines1 = Wine.create!({name: 'Layer Cake', year: '2020', price: '18.99', description: 'yummy', img: 'http://library.bevnetwork.com/bottles/540/173345.jpg'})
 ...
 @wines5 = Wine.create!({name: 'Sonoma Coast', year: '2019', price: '25.00', description: 'yummy', img: 'https://www.lacrema.com/wp-content/uploads/2015/10/NV-SoCo-Pinot.png'})
 ...
 @wines7 = Wine.create!({name: 'The Prisoner Red Blend', year: '2019', price: '28.99', description: 'California - This red blend shows aromas of ripe cherry and cedar with hints of rose petal and sweet oak. The lovely entry leads into a savory mid palate. Ripe fig and black currant dominate the finish with soft well integrated tannins.', img: 'https://www.totalwine.com/dynamic/x1000,375ml/media/sys_master/twmmedia/h02/h79/13784584126494.png'})
 ...
 Rating.create!({ rank: '3', user: @user1, wine: @wines2})
 Rating.create!({ rank: '1', user: @user1, wine: @wines3})
 Rating.create!({ rank: '5', user: @user1, wine: @wines4})
